...
public class DestructionLevel : MonoBehaviour, ILevel
{
    ...
    public ObjectiveType Objective { get => ObjectiveType.Destroy; set => throw new System.NotImplementedException(); }
