...
[CreateAssetMenu(fileName = "New_CheckerNoise", menuName = "Custom/Noise/Checker")]
public class CheckerGenerator : ScriptableObject, INoise
{
    [SerializeField] Checker _generator = null;
    public Checker Generator
    {
        get
        {
            if(_generator == null)
                _generator = new Checker();
