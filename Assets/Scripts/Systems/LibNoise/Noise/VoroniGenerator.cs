...
[CreateAssetMenu(fileName = "New_VoronoiNoise", menuName = "Custom/Noise/Voronoi")]
public class VoronoiGenerator : ScriptableObject, INoise
{
    ...
    public Voronoi Generator
    {
        ...
        {
            if(_generator == null)
                _generator = new Voronoi(Frequency, Lacunarity, Seed, false);
