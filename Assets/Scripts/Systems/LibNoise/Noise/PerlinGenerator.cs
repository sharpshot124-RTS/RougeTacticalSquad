...
[CreateAssetMenu(fileName = "New_PerlinNoise", menuName = "Custom/Noise/Perlin")]
public class PerlinGenerator : ScriptableObject, INoise
{
    [SerializeField] Perlin _generator = null;
    public Perlin Generator
    {
        get
        {
            if(_generator == null)
                _generator = new Perlin(Frequency, Lacunarity, Persistence, Octaves, Seed, LibNoise.QualityMode.High);
