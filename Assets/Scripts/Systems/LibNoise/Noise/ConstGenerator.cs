...
[CreateAssetMenu(fileName = "New_ConstNoise", menuName = "Custom/Noise/Const")]
public class ConstGenerator : ScriptableObject, INoise
{
    [SerializeField] Const _generator = null;
    public Const Generator
    {
        get
        {
            if(_generator == null)
                _generator = new Const(frequency);
