...
[CreateAssetMenu(fileName = "New_RidgedMultifractalNoise", menuName = "Custom/Noise/RidgedMultifractal")]
public class RidgedMultifractalGenerator : ScriptableObject, INoise
{
    [SerializeField] RidgedMultifractal _generator = null;
    public RidgedMultifractal Generator
    {
        get
        {
            if(_generator == null)
                _generator = new RidgedMultifractal(Frequency, Lacunarity, Octaves, Seed, LibNoise.QualityMode.High);
