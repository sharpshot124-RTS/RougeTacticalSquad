...
[CreateAssetMenu(fileName = "New_CylindersNoise", menuName = "Custom/Noise/Cylinders")]
public class CylindersGenerator : ScriptableObject, INoise
{
    [SerializeField] Cylinders _generator = null;
    public Cylinders Generator
    {
        get
        {
            if(_generator == null)
                _generator = new Cylinders(Frequency);
