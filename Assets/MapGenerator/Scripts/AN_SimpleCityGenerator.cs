                    ...
                    case (1): // 1x1
                        {
                            ...
                            Instantiate( List1x1[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, 90 * Random.Range(0,4), 0) );
                            break;
                        }
                    case (21): // 1x2
                        {
                            selected = SelectPrefab(List1x2);
                            Instantiate(List1x2[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, 0, 0));
                            break;
                        }
                    case (22): // 1x2 rotate -90
                        {
                            selected = SelectPrefab(List1x2);
                            Instantiate(List1x2[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, -90, 0));
                            break;
                        }
                    case (31): // angle
                        {
                            selected = SelectPrefab(ListAngle);
                            Instantiate(ListAngle[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, 0, 0));
                            break;
                        }
                    case (32): // angle rotate -90
                        {
                            selected = SelectPrefab(ListAngle);
                            Instantiate(ListAngle[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, -90, 0));
                            break;
                        }
                    case (41): // sqare
                        {
                            selected = SelectPrefab(ListSqare);
                            Instantiate(ListSqare[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, 0, 0));
                            break;
                        }
                    case (42): // sqare shift
                        {
                            selected = SelectPrefab(ListSqare);
                            Instantiate(ListSqare[selected].gameObject, new Vector3Int(x - MapLength / 2, 0, y - MapLength / 2) * SqareLength + CityCentre, Quaternion.Euler(0, 180, 0));
                            break;
                        }
                    default:
                        break;
